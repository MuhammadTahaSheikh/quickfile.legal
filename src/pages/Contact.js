      ...
      >
        <Container maxWidth="lg">
          ...
          <Typography variant="h6" sx={{ maxWidth: '600px', mx: 'auto' }}>
            Get in touch with our team. We're here to help you succeed with quickfile.legal.
          </Typography>
        </Container>
      </Box>
        ...
        <Grid container spacing={6}>
          ...
          <Grid item xs={12} md={6}>
            ...
            <Typography variant="body1" paragraph color="text.secondary">
              Have questions about quickfile.legal? Need technical support? Want to learn more about 
        ...
        <Box sx={{ mt: 8, textAlign: 'center' }}>
          <Paper sx={{ p: 4, backgroundColor: '#e3f2fd' }}>
            ...
            <Typography variant="body1" paragraph>
              ...
              <strong> (833) 657-4812</strong>. Our support team is available during business hours 
